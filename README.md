...
✓ আমাদের দেওয়া **index.html** ফাইলে একাধিক <svg> ট্যাগ রয়েছে। প্রতিটি <svg> আইকনের জন্য একটি **আলাদা কম্পোনেন্ট** তৈরি করতে হবে। যেমন, কোনো জায়গায় যদি <svg>...</svg> কোড ব্যবহার করা হয়ে থাকে, তাহলে সেই অংশটি কপি করে একটি নতুন কম্পোনেন্টে রাখতে হবে এবং সেই SVG কোডটি **return** করতে হবে। এরপর React প্রজেক্টে সরাসরি <svg>...</svg> না লিখে, সেই কম্পোনেন্টটি ব্যবহার করতে হবে। উদাহরণস্বরূপ: <svg>...</svg> এর পরিবর্তে <IconComponent /> লিখতে হবে।
